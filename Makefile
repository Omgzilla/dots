...
work:
	$(STOW) bash bin brave chromium DankMaterialShell fontconfig fonts foot gtk-work hypr hypr-work mango mimeapps-work nvim quickshell-work rofi shell-work terminator waybar waypaper-work tmux zed
